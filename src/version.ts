 ...
 * plugin actually uses (e.g. `^0.1.0-rc.6`).
 *
 * Dependency-free on purpose; it implements the subset of node-semver
 * semantics needed to turn a silent peer mismatch into a loud, actionable
 * load error.
 */
